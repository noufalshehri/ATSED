...
namespace ATSED_Staff
{
    public partial class SickLeaveForm : Form
    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("UPDATE printing SET ar_nat ='" + textBox4.Text + "' WHERE id = " + id + "; ", cn);
            cmd.ExecuteNonQuery();
            //**//
            ...
            //**//
            cmd = new SqlCommand("UPDATE printing SET days ='" + textBox7.Text + "' where time = (select max(time) from printing where id = " + id + " );", cn);
            cmd.ExecuteNonQuery();
